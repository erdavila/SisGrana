...
import utils.{BrNumber, IndentedPrinter, oppositeSigns, sameNonZeroSigns}
...
object Formatting {
  ...
  private[investments] def formatPositionChange(posBefore: Amount, posAfter: Amount, withLabel: Boolean = true): String = {
    val formatted = {
  ...
  implicit private[investments] class DoubleOps(private val double: Double) extends AnyVal {
